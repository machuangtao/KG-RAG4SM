...
def main():
    ...
    output_path = 'test_mimic_q_with_paths.xlsx'
    text_output_path = 'paths_mimic_output.txt'

    try:
        # Read data from 'test_mimic_q.xlsx'
        df = pd.read_excel('test_mimic_q.xlsx')

        # Load the JSON file with similar entities
        with open('result_test_mimic.json', 'r') as f:
