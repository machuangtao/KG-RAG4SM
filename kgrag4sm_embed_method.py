...
def get_data_file(dataset: str) -> str:
    dataset_mapping = {
        "cms": "datasets/reproduce/test_cms_q_embed_method_jina.xlsx"
    }
...
def main():
    ...
    parser.add_argument('--retrieved_paths', type=str, default="jina_top_1",
                      help='retrieved paths: jina_all, jina_top_1, jina_top_2')
