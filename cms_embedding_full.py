...
class EmbeddingsGenerator:
    ...
    def initialize_chromadb(self):
        ...
        persist_directory = os.path.join(os.getcwd(), 'test_embedding_full')
        ...
        collection_name = "test_embedding_questions_full"
        ...
        try:
            self.collection = self.client.create_collection(
                ...
                metadata={"description": "test questions embeddings using all-distilroberta-v1"}
            )
...
def main():
    ...
    try:
        ...
        excel_file_path = '/app/datafinal/test.xlsx'
