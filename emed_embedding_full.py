...
class EmbeddingsGenerator:
    ...
    def initialize_chromadb(self):
        ...
        persist_directory = os.path.join(os.getcwd(), 'emed_ques_embedding_full2')
        ...
        collection_name = "sentence_embedding_emed_questions_full2"
        ...
        try:
            self.collection = self.client.create_collection(
                ...
                metadata={"description": "emed questions embeddings using all-distilroberta-v1"}
            )
