...
input_xlsx = os.path.join(datafinal_dir, "test_mimic_q.xlsx")  # Ensure this file exists and has a 'question_id' column
output_xlsx = os.path.join(datafinal_dir, "test_mimic_q_method2.xlsx")
json_file = os.path.join(layers_dir, "mimic_top10_similar2.json")  # Changed to mimic_top10_similar2.json
