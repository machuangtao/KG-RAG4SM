...
from src.umlskgrag4sm import KGRAG_for_Schema_Matching
...
def main():
    ...
    parser.add_argument('--log_dir', type=str, default='logs/umls/kgrag', help='Directory for storing logs')
    parser.add_argument('--device', type=str, default='cuda', help='cuda or cpu')
    parser.add_argument('--retrieved_paths', type=str, default="umls_domain_kg_paths_full",
