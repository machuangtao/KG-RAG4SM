...
def main():
    ...
    output_path = 'test_emed_q_with_paths.xlsx'
    text_output_path = 'paths_emed_output.txt'

    try:
        # Read data from 'test_emed_q.xlsx'
        df = pd.read_excel('test_emed_q.xlsx')

        # Load the JSON file with similar entities
        with open('result_test_emed.json', 'r') as f:
