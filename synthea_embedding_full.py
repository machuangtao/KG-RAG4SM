...
class EmbeddingsGenerator:
    ...
    def initialize_chromadb(self):
        ...
        persist_directory = os.path.join(os.getcwd(), 'synthea_ques_embedding_full2')
        ...
        collection_name = "sentence_embedding_synthea_questions_full2"
        ...
        try:
            self.collection = self.client.create_collection(
                ...
                metadata={"description": "synthea questions embeddings using all-distilroberta-v1"}
            )
    ...
    def store_question_embeddings(self, items, batch_size=4):
        """
        Stores question embeddings in ChromaDB in batches.
        Measures and prints total and average processing time at the end.

        Changes:
        - Reduced batch_size to ease memory consumption.
        - Explicitly delete large arrays and call gc.collect() after each batch.
        """
