...
class EmbeddingsGenerator:
    ...
    def initialize_chromadb(self):
        ...
        persist_directory_questions = os.path.join(
            current_dir, 'chromadb_store_sentence_embedding_mimic_questions'
        )
        persist_directory_entities = os.path.join(
            current_dir, 'chromadb_store_wikidata_entities_sentence_embedding_mimic'
        )
        persist_directory_relationships = os.path.join(
            current_dir, 'chromadb_store_wikidata_relationships_sentence_embedding_mimic'
        )
        ...
        try:
            self.client_questions.delete_collection(name="sentence_embedding_mimic_questions_collection")
            print("Deleted existing 'sentence_embedding_mimic_questions_collection' to avoid dimension mismatches.")
        except Exception:
            pass

        try:
            self.client_entities.delete_collection(name="wikidata_entities_sentence_embedding_mimic")
            print("Deleted existing 'wikidata_entities_sentence_embedding_mimic' collection to avoid dimension mismatches.")
        except Exception:
            pass

        try:
            self.client_relationships.delete_collection(name="wikidata_relationships_sentence_embedding_mimic")
            print("Deleted existing 'wikidata_relationships_sentence_embedding_mimic' collection to avoid dimension mismatches.")
        except Exception:
            pass

        # Create new collections
        self.collection_questions = self.client_questions.create_collection(
            name="sentence_embedding_mimic_questions_collection"
        )
        print("Created new 'sentence_embedding_mimic_questions_collection'.")

        self.collection_entities = self.client_entities.create_collection(
            name="wikidata_entities_sentence_embedding_mimic"
        )
        print("Created new 'wikidata_entities_sentence_embedding_mimic' collection.")

        self.collection_relationships = self.client_relationships.create_collection(
            name="wikidata_relationships_sentence_embedding_mimic"
        )
        print("Created new 'wikidata_relationships_sentence_embedding_mimic' collection.")
...
def main():
    ...
    try:
        ...
        # Path to your test_mimic_q.xlsx file
        ...
        with open('result_sentence_embedding_mimic.json', 'w', encoding='utf-8') as json_file:
