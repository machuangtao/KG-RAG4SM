...
class SimilarityFinder:
    ...
    def load_questions_and_embeddings(self):
        ...
        try:
            ...
            chroma_dir = os.path.join(os.getcwd(), 'emed_ques_embedding_full')
    ...
    def save_results(self, results):
        ...
        try:
            json_path = "emed_wikidata_similar_full.json"
            if TEST_MODE:
                json_path = "emed_wikidata_similar_test.json"
            
            with open(json_path, 'w', encoding='utf-8') as f:
                json.dump(results, f, ensure_ascii=False, indent=2)
            logger.info(f"Results saved to {json_path}")
            
            txt_path = "emed_wikidata_similar_full.txt"
            if TEST_MODE:
                txt_path = "emed_wikidata_similar_test.txt"
