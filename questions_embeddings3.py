...
class EmbeddingsGenerator:
    ...
    def initialize_chromadb(self):
        ...
        # Create a new collection with 'l2' (Euclidean distance)
        self.collection_questions = self.client_questions.create_collection(
            name="questions_collection",
            metadata={'hnsw:space': 'l2'}
        )
        print("Created new 'questions_collection' with Euclidean distance.")
        ...
        print("Created new 'wikidata_entities' collection with Euclidean distance.")
        ...
        print("Created new 'wikidata_relationships' collection with Euclidean distance.")
    ...
    def store_question_embeddings(self, items):
        ...
        for start_idx in tqdm(
            ...
            # Do NOT normalize embeddings for Euclidean distance
...
"""
        ...
        with open('result_euclidean.txt', 'w', encoding='utf-8') as result_file:
            ...
            for idx, question in enumerate(tqdm(questions, desc="Processing questions")):
                ...
                if result_data and 'embeddings' in result_data and len(result_data['embeddings']) > 0:
                    ...
                    # Do NOT normalize query embedding for Euclidean distance
