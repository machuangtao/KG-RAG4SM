...
input_xlsx = os.path.join(datafinal_dir, "test_cms_q.xlsx")
output_xlsx = os.path.join(datafinal_dir, "test_cms_q_method2.xlsx")
json_file = os.path.join(layers_dir, "cms_top10_similar2.json")
