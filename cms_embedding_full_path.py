...
def main():
    ...
    with open('cms_wikidata_similar_full.json', 'r') as f:
        data = json.load(f)
    ...
    with open('cms_wikidata_full_path.json', 'w', encoding='utf-8') as f:
        json.dump(output, f, indent=2, ensure_ascii=False)

    logger.info(f"Processing completed. Results saved to cms_wikidata_full_path.json")
