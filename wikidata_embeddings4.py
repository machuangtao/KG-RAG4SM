...
class EmbeddingsGenerator:
    ...
    def initialize_chromadb(self):
        ...
        # Path for val_mimic_questions embeddings
        persist_directory_questions = os.path.join(
            base_dir, 'chromadb_store_val_mimic_questions'
        )
        ...
        try:
            ...
            if "val_mimic_questions_collection" in collection_names:
                self.collection_questions = self.client_questions.get_collection(
                    name="val_mimic_questions_collection"
                )
                print("Questions collection loaded successfully.")
            else:
                print("Questions collection 'val_mimic_questions_collection' does not exist.")
...
def main():
    ...
    try:
        ...
        with open('mimic_val_results.txt', 'w', encoding='utf-8') as result_file:
        ...
        with open('mimic_val_results.json', 'w', encoding='utf-8') as f:
