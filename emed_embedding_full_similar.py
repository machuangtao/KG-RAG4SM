...
class SimilarityFinder:
    ...
    def initialize_chromadb_clients(self):
        ...
        self.client_questions = chromadb.Client(Settings(
            ...
            persist_directory=os.path.join(base_dir, 'emed_ques_embedding_full')
        ))
        ...
        # Get collections
        self.collection_questions = self.client_questions.get_collection("sentence_embedding_emed_questions_full")
    ...
    def find_similar_items(self):
        ...
        for idx, (q_id, q_embedding, question_text) in enumerate(
            ...
            print(f"\nProcessing question {idx}/{len(questions_data['ids'])}")
    ...
    def save_results(self, results):
        ...
        # Save JSON
        with open('emed_wikidata_similar_full.json', 'w', encoding='utf-8') as f:
            json.dump(output, f, indent=2, ensure_ascii=False)
            
        # Save readable text summary
        with open('emed_wikidata_similar_full.txt', 'w', encoding='utf-8') as f:
