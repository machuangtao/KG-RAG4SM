...
def main():
    ...
    try:
        ...
        with open('bfs_paths_and_top_k_entities_results.txt', 'w', encoding='utf-8') as result_file:
            ...
            for question_id, question_text in zip(question_ids, question_texts):
                ...
                if not refined_subgraph:
                    write_and_print("No paths in BFS subgraph match the top entities and relationships.")
                    continue
                ...
                write_and_print("Refined Subgraph Context:")
                for parent_id, prop_id, entity_id in refined_subgraph:
