...
def main():
    ...
    synthea_dir = os.path.join(collections_base, "synthea_ques_embedding_full")
    ...
    max_questions = synthea_embeddings.shape[0]  # Change this to synthea_embeddings.shape[0] to process all questions
    max_questions = min(max_questions, synthea_embeddings.shape[0])
    ...
    for gpu_id, (gpu_idx, start_q, end_q) in enumerate(gpu_question_assignments):
        ...
        for q in range(start_q, end_q):
            ...
            q_embedding = synthea_embeddings[q]
